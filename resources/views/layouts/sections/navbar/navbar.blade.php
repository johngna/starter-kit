        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item {{ app()->getLocale() === 'pt_BR' ? 'active' : '' }}"
                  href="{{url('lang/pt_BR')}}" data-language="de" data-text-direction="ltr">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              {{-- <li>
                <a class="dropdown-item"
                  href="{{ Route::has('profile.show') ? route('profile.show') : 'javascript:void(0);' }}">
                  <i class="ti ti-user me-3 ti-md"></i><span class="align-middle">@lang('My Profile')</span>
                </a>
              </li> --}}
              ...
              <li>
                <div class="d-grid px-2 pt-2 pb-1">
                  <a class="btn btn-sm btn-danger d-flex"
                    ...
                    <small class="align-middle">@lang('Login')</small>
