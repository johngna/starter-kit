        ...
        <div data-repeater-list="group-a">
          ...
          <div data-repeater-item>
            <div class="row">
              ...
              <div class="mb-6 col-lg-6 col-xl-2 col-12 mb-0">
                <x-select label="Tipo" name="custom[type]" wire:model.live="custom.type" :options="$types" />
              </div>
              <div class="mb-6 col-lg-6 col-xl-2 col-12 mb-0">
          ...
          <div data-repeater-item>
            <div class="row">
              ...
              <div class="mb-6 col-lg-6 col-xl-2 col-12 mb-0">
                <x-select label="Tipo" name="custom[{{$index}}][type]" wire:model.live="customs.{{$index}}.type"
                  :options="$types" disabled />
              </div>
              <div class="mb-6 col-lg-6 col-xl-2 col-12 mb-0">
              ...
              <div class="mb-6 col-lg-6 col-xl-1 col-12 mb-0">
                <x-input type="number" label="Ordem" name="custom[{{$index}}][order]"
                  wire:model.live="customs.{{$index}}.order" disabled />
              </div>
              <div class="mb-6 col-lg-6 col-xl-1 col-12 mb-0">
                <x-switch label="Obrigatório" name="custom[{{$index}}][is_required]"
                  wire:model.live="customs.{{$index}}.is_required" disabled />
              </div>
              <div class="mb-6 col-lg-6 col-xl-1 col-12 mb-0">
                <x-switch label="Ativo" name="custom[{{$index}}][is_active]"
                  wire:model.live="customs.{{$index}}.is_active" disabled />
              </div>
