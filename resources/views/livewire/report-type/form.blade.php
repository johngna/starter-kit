<div>
  ...
  <div
    ...
    <div class="d-flex align-content-center flex-wrap gap-4">
      <button type="button" class="btn btn-danger" id="confirm-text" data-id="{{$reportId}}" data-method="removeReport">
        Excluir
      </button>
    ...
    <form wire:submit.prevent="save" id="category_form">
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <div class="row mb-6">
            <x-quill-editor label="Descrição" id="editor1" name="description" model="description" placeholder=''
